...
📍 Abu Dhabi, UAE &nbsp;|&nbsp; 🎓 Year 2 · UOWD &nbsp;|&nbsp; 🔗 [LinkedIn](https://www.linkedin.com/in/advait-awankumar-meshram-b75a80333/)
...
Passionate about robotics, embedded systems, and autonomous technologies — I build my skills through hands-on projects and structured self-learning. Everything I learn, I document and push here.
...
All projects are organized inside my **[ROS2Sandbox repo](https://github.com/advaitmeshram/ROS2-sandbox)**, grouped by category.

### 🔹 Linux
- **Linux Notes & Commands**
  Notes and small scripts from the *Linux for Robotics* course.
...
- **Talker/Listener Package**
  First ROS 2 package implementing publisher/subscriber messaging (`std_msgs/String`).
  *Technologies:* ROS2, rclpy
  [View in repo](https://github.com/advaitmeshram/ROS2-sandbox/tree/main/colcon_ws/src/talker_listener)

- **ROS 2 Study Notes**
  Notes on nodes, topics, services, and actions.
  *Technologies:* ROS2
...
- 🔄 Linux for Robotics — *The Construct (in progress)*
- 🔄 Python 3 for Robotics — *The Construct (in progress)*
- 🔄 ROS2 Basics — *The Construct (in progress)*
...
- Cloud Robotics — ROS2 + Cloud integration
- AI/ML for Robotics — YOLO-based object detection
